...
# Folder parameters
image_folder = f'images/fixed-action_agent/ucb_logistic_{no_actions}'
...
ut.plot_smooth_reward_history(
    ...
    bandit2_name='Fixed-Action Agent', foldername=image_folder, filename='ucb_logistic_rewards')
