...
# Folder parameters
image_folder = f'images/fixed-action_agent/epsgreedy_logistic_{no_actions}'
result_folder = f'results/fixed-action_agent/epsgreedy_logistic_{no_actions}'
...
ut.plot_smooth_reward_history(
    ...
    bandit2_name='Fixed-Action Agent', foldername=image_folder, filename='epsgreedy_logistic_rewards')
