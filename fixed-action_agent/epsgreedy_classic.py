...
from models import StationaryClassicModel
...
model = StationaryClassicModel(variance=variance, candidate_margins=action_set)
...
ut.print_result_to_file(reward_1_sum, reward_2_sum, os.path.join(
    result_folder, 'total_rewards.txt'), 'Classic Eps-Greedy', 'Fixed-Action Agent')
