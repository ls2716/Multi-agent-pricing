...
a dummy agent which quotes sequential action."""
...
# Import sequential action agent
...
tau = 100  # Window size for sliding window method

quantile = 0.7  # q for UCB-Bayes
variance = 1.
...
ut.print_result_to_file(reward_1_sum, reward_2_sum, os.path.join(
    result_folder, 'total_rewards.txt'), 'Classic UCB-Bayes', 'Fluctuating-action Agent')
