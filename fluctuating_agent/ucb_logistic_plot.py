...
# Folder parameters
image_folder = f'images/fluctuating_agent/ucb_logistic_{no_actions}'
...
ut.plot_action_history(action_set, bandit_action_frequencies,
                       foldername=image_folder, filename='ucb_logistic_actions')
ut.plot_smooth_reward_history(
    reward_history, bandit1_name='Logistic UCB-Bayes',
    bandit2_name='Fluctuating-action Agent', foldername=image_folder, filename='ucb_logistic_rewards')
