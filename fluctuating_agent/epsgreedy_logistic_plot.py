...
# Folder parameters
image_folder = f'images/fluctuating_agent/epsgreedy_logistic_{no_actions}'
result_folder = f'results/fluctuating_agent/epsgreedy_logistic_{no_actions}'
...
ut.print_result_to_file(reward_1_sum_500, reward_2_sum_500, os.path.join(
    result_folder, 'last_500.txt'), 'Logistic Eps-Greedy', 'Fluctuating-action Agent')
...
ut.plot_action_history(action_set, bandit_action_frequencies,
                       foldername=image_folder, filename='epsgreedy_logistic_actions')
ut.plot_smooth_reward_history(
    reward_history, bandit1_name='Logistic Eps-Greedy',
    bandit2_name='Fluctuating-action Agent', foldername=image_folder, filename='epsgreedy_logistic_rewards')
