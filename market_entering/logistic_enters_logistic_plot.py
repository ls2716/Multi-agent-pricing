...
# Plotting parameters
results_folder = f'results/market_entering/logistic_enters_logistic_no_actions_{no_actions}_T_{T}'
images_folder = f'images/market_entering/logistic_enters_logistic_no_actions_{no_actions}_T_{T}'
...
ut.print_result_to_file(reward_1_sum, reward_2_sum, os.path.join(
    results_folder, 'full_episode.txt'), 'Logistic Eps-Greedy', 'Logistic Eps-Greedy entering')
...
ut.print_result_to_file(reward_1_sum_500, reward_2_sum_500, os.path.join(
    results_folder, 'last_500.txt'), 'Logistic Eps-Greedy', 'Logistic Eps-Greedy entering')
...
ut.print_result_to_file(reward_1_mean_500, reward_2_mean_500, os.path.join(
    results_folder, 'mean_last_500.txt'), 'Logistic Eps-Greedy', 'Logistic Eps-Greedy entering')

ut.plot_smooth_reward_history(
    reward_history, bandit1_name='Logistic Eps-Greedy',
    bandit2_name='Logistic Eps-Greedy entering', foldername=images_folder, filename='reward_plot.png', title=None, show_plot=False)
