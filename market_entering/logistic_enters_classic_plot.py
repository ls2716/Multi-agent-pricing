...
images_folder = f'images/market_entering/logistic_enters_classic_no_actions_{no_actions}_T_{T}'
...
ut.print_result_to_file(reward_1_sum, reward_2_sum, os.path.join(
    results_folder, 'full_episode.txt'), 'Classic Eps-Greedy', 'Logistic Eps-Greedy entering')
...
ut.print_result_to_file(reward_1_sum_500, reward_2_sum_500, os.path.join(
    results_folder, 'last_500.txt'), 'Classic Eps-Greedy', 'Logistic Eps-Greedy entering')
...
ut.print_result_to_file(reward_1_mean_500, reward_2_mean_500, os.path.join(
    results_folder, 'mean_last_500.txt'), 'Classic Eps-Greedy', 'Logistic Eps-Greedy entering')
