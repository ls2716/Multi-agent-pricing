...
# Plotting parameters
results_folder = f'results/market_entering/classic_enters_logistic_no_actions_{no_actions}_T_{T}'
images_folder = f'images/market_entering/classic_enters_logistic_no_actions_{no_actions}_T_{T}'
...
ut.print_result_to_file(reward_1_sum, reward_2_sum, os.path.join(
    results_folder, 'full_episode.txt'), 'Logistic Eps-Greedy', 'Classic Eps-Greedy entering')
